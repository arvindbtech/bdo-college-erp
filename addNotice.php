        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="col-sm-2 ml-auto">
                    <a href="noticeList.php" class="btn btn-block btn-info btn-sm">Notice List (s)</a>
                </div>
            </div>
            <!-- /.content-header -->
                                ...
                                <form action="noticeAction.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="trainingstatus">Title</label>
                                                    <input type="text" name="training_title" class="form-control"
                                                        id="training_title" placeholder="Enter training title">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="facultyname">Letter (Only pdf file)</label>
                                                    <input type="file" name="training_file" class="form-control" id="training_file" accept=".pdf">

                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="trainingmaterials">Date</label>
                                                    <input type="text" name="training_date"
                                                        class="form-control" id="training_date"
                                        ...
                                        <div class="col-md-12">
    <div class="form-group">
        <label for="training_details">Description</label>
        <textarea name="training_details" class="form-control" id="training_details" rows="3" maxlength="150" placeholder="Enter description"></textarea>
    </div>
</div>
