...
$selected_hall = $row['training_hall'];
$selected_department = $row['department_name'];
$existing_file = $row['training_approval_letter'];
$projector_checked = $row['projector'];
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="training_hall" id="training_hall">
                                                        <option disabled <?php echo ($selected_hall == '') ? 'selected' : ''; ?>>Select</option>
                                                        <option value="1" <?php echo ($selected_hall == 1) ? 'selected' : ''; ?>>Vishakha Auditorium</option>
                                                        <option value="2" <?php echo ($selected_hall == 2) ? 'selected' : ''; ?>>Swati Training Hall</option>
                                                        <option value="3" <?php echo ($selected_hall == 3) ? 'selected' : ''; ?>>Revati Training Hall</option>
                                                        <option value="4" <?php echo ($selected_hall == 4) ? 'selected' : ''; ?>>Classroom-108</option>
                                                        <option value="5" <?php echo ($selected_hall == 5) ? 'selected' : ''; ?>>Classroom-111</option>
                                                        <option value="6" <?php echo ($selected_hall == 6) ? 'selected' : ''; ?>>Classroom-112</option>
                                                        <option value="7" <?php echo ($selected_hall == 7) ? 'selected' : ''; ?>>Classroom-226</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="department_name" id="department_name">
                                                        <option disabled <?php echo ($selected_department == '') ? 'selected' : ''; ?>>Select</option>
                                                        <option value="State Urban Digital Mission" <?php echo ($selected_department == 'State Urban Digital Mission') ? 'selected' : ''; ?>>State Urban Digital Mission</option>
                                                        <option value="Swachh Bharat Mission" <?php echo ($selected_department == 'Swachh Bharat Mission') ? 'selected' : ''; ?>>Swachh Bharat Mission</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="reservationdatetime"
                                                        ...
                                                        <input type="text" name="training_date_from"
                                                            id="training_date_from" value="<?php echo $row['training_date_from']; ?>"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="training_date_to"
                                                        data-target-input="nearest">
                                                        <input type="text" name="training_date_to" id="training_date_to" value="<?php echo $row['training_date_to']; ?>"
                                                            class="form-control datetimepicker-input"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="training_mode" class="form-control"
                                                        id="training_mode" value="<?php echo $row['training_mode']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="faculty_name" class="form-control"
                                                        id="faculty_name" value="<?php echo $row['faculty_name']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="number_of_participants"
                                                        ...
                                                        value="<?php echo $row['number_of_participants']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="training_materials_url"
                                                        ...
                                                        value="<?php echo $row['training_materials_url']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="training_approval_letter" class="custom-file-input" id="training_approval_letter">
                                                            <label class="custom-file-label" for="training_approval_letter">
                                                                <?php echo (!empty($existing_file)) ? $existing_file : "Choose file"; ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="checkbox" name="projector" class="form-check-input" id="projector" value="1"
                                                        <?php echo ($projector_checked == 1) ? 'checked' : ''; ?>>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="food_beverage"
                                                                class="form-check-input" id="food_beverage" value="1" <?php echo ($row['food_beverage'] == 1) ? 'checked' : ''; ?>>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="accommodation"
                                                                class="form-check-input" id="accommodation" value="1" <?php echo ($row['accommodation'] == 1) ? 'checked' : ''; ?>>
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="screen"
                                                                class="form-check-input" id="screen" value="1" <?php echo ($row['screen'] == 1) ? 'checked' : ''; ?>>
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="training_handouts"
                                                                class="form-check-input" id="training_handouts" value="1" <?php echo ($row['training_handouts'] == 1) ? 'checked' : ''; ?>>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="training_key_notes"
                                                                class="form-check-input" id="training_key_notes" value="1" <?php echo ($row['training_key_notes'] == 1) ? 'checked' : ''; ?>>
                                                            <label class="form-check-label" for="exampleCheck1">Training
                                                                Key Notes</label>
                                                        </div>
                                                    </div>
